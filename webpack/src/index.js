import { Canvas, Circle, Rectangle, Triangle, Ellipse } from 'diagramax';
import 'diagramax/diagramax.css';
import './style.css';

// Also CommonJS importing is supported.
// const Diagramax = require('diagramax');
// const { Circle, Canvas, Rectangle } = Diagramax;
